      ...
      <div className="bg-zinc-900 p-8 rounded-lg">
        <div className="flex justify-between items-center mb-12">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-full text-white bg-lime-500 hover:bg-lime-500"
          >
      ...
      <div className="bg-zinc-900 p-8 rounded-lg">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-64 h-32 relative">
            <div className="absolute top-0 left-0 bg-lime-500 p-2 rounded-lg">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 max-w-[200px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="w-16 h-16 relative">
              <div className="w-16 h-8 bg-zinc-100 rounded-t-full" />
              <div className="w-16 h-8 bg-black rounded-b-full" />
              <div className="absolute bottom-0 right-0 bg-lime-500 p-1 rounded-lg">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
