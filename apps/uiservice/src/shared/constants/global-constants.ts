...
export const uiConstants = {
  ...
  modelsHeader: `Explore our generic & trained models that supports advanced language processing tools that can generate, classify, and summarize text with high levels of coherence and accuracy.`,
  ...
  pricingTierHeader: `Choose an ${brandName} subscription that is right for you. Downgrade, upgrade any time. ${brandName} offers a free and premium plan to meet your requirements.`,
